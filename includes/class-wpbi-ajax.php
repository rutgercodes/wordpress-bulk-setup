 ...
 * Settings class
 */
if ( !class_exists( 'WordPress_Bulk_Install_Ajax' ) ) {

	class WordPress_Bulk_Install_Ajax {
		...
		public function load_admin_ajax() {
			...
			add_action( 'wp_ajax_'.WordPress_Bulk_Install::$plugin_prefix.'install_plugin', array($this, 'install_plugin') );
			add_action( 'wp_ajax_'.WordPress_Bulk_Install::$plugin_prefix.'install_theme', array($this, 'install_theme') );

		}

		public function install_plugin() {

			include_once( 'class-wpbi-plugins.php' );
			...
			if( WordPress_Bulk_Install_Plugins::is_plugin_installed($slug) ) {
				echo json_encode( array(
					"error" => true,
			...
			$installed = WordPress_Bulk_Install_Plugins::install_plugin( $api->download_link );
			...
			$activated = WordPress_Bulk_Install_Plugins::activate_plugins( $slug );
		...
		public static function install_theme() {
			...
			include_once( 'class-wpbi-themes.php' );
			...
			$theme_info = WordPress_Bulk_Install_Themes::get_theme_info($theme);

			// echo "theme slug: " . print_r( $theme_info, true );
			// echo "checking slug: " . WordPress_Bulk_Install_Themes::is_theme_installed($theme_info['slug']);
			...
			if( WordPress_Bulk_Install_Themes::is_theme_installed($theme_info['data']['slug']) ) {
				echo json_encode( [
					"error" => true,
			...
			$installer = WordPress_Bulk_Install_Themes::install_theme( $theme );
